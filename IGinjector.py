...
while opcion != 3:
    ...
    if opcion == 1:
       ...
       time.sleep(5)
        ...
        #Cookies y numero/correo
        browser.find_element_by_xpath('/html/body/div[4]/div[1]/div/div[2]/div/div/div/div/div[2]/div/button[1]').send_keys(Keys.RETURN)
        sleep(4)
        browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/div[2]/div/div/div/div/div[4]/form/label/input').send_keys(v)
        sleep(2)
        browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/div[2]/div/div/div/div/div[4]/form/label/input').send_keys(Keys.RETURN)
        sleep(4)
        os.system('clear')
        print("")
        print("[AVISO] Este paso es opcional, si quiere un scaneo sigiloso solo dele a enter.[AVISO]")
        print("")
        c=input("[ADVERTENCIA] Complete el capcha y pulse siguiente despues pulse enter en la terminal.[ADVERTENCIA] ")
        sleep(4)
        try:
        ...
        #cookies
        os.system('clear')
        elemento = browser.find_element_by_xpath('/html/body/div[5]/div[1]/div/div[2]/div/div/div/div/div[2]/div/button[1]').send_keys(Keys.RETURN)
        sleep(4)
        
        #login
        os.system('clear')
        elemento = browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/div/div/div[1]/div[2]/form/div/div[1]/div/label/input').send_keys(correo)
        sleep(2)
        os.system('clear')
        elemento = browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/div/div/div[1]/div[2]/form/div/div[2]/div/label/input').send_keys(password)
        sleep(2)
        os.system('clear')
        elemento = browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/section/main/div/div/div[1]/div[2]/form/div/div[2]/div/label/input').send_keys(Keys.RETURN)
        sleep(8)
        os.system('clear')
        ...
        try:
          os.system('clear')
          sleep(4)
          elemento = browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/div[3]/div[3]/a/span/span')
        ...
        print("//////////////////////////////////////////////////////////////")
        os.system('bash modules/photo.sh')
        print("Nombre :", frase1)
