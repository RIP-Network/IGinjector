...
def mostrar_menu():
   ...
   print("")
   print(rojo+"                        [*] 2. Informacion de un usuario mas amplia."+cierre + rojo+" (Free Version) (Necesita una Cuenta de Instagram) "+cierre)
   print("")
...
while opcion != 3:
    ...
    if opcion == 1:
        ...
        print("Primeros 10 seguidores : Proximamente ")
        print("Ultimos 10 seguidores : Proximamente ")
        print("Hastags de las publicaciones : Proximamente ")
        print("Informacion de ubicacion de las publicaciones :Proximamente")
        print("//////////////////////////////////////////////////////////////")
        print("")
        break
