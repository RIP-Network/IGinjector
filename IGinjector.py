...
def mostrar_menu():
   ...
   print(rojo+"                                                         ✓ Version 6.7 ✓                                       "+cierre)
   print("")
   print(rojo+"           [ADVERTENCIA] Es posible que la herramienta haga 3 scaneos luego no funcione, dejela reposar. [ADVERTENCIA]")
   print("")
   print("")
   print(rojo+"                        [*] 1. Informacion de un usuario."+cierre + rojo+" (Free Version) (Fuera de Servicio)"+cierre)
   print("")
   print(rojo+"                        [*] 2. Informacion de un usuario mas amplia."+cierre + rojo+" (Free Version) (En Servicio) (Necesita una Cuenta) "+cierre)
   print("")
   print(rojo+"                        [*] 3. Bypassear cuenta privada."+cierre + rojo+" (Premiun Version) (Proximamente)"+cierre)
   print("")
...
while opcion != 3:
    ...
    if opcion == 1:
        ...
        print("")
        os.system('clear')
        print("Intentando Conseguir Credenciales de la Cuenta.")
        sleep(5)
        ...
        try:
          ...
          try:
           ...
           print("Error : Es posible que no se haya instalado bien ChromeDriver o estes ejecutandolo con Root.", str(e))
           sleep(5)
           verify = ""
